        ...
        <>
            <Row className="py-5">
                ...
                <Col className="py-5">
                    ...
                    <Badge bg="warning" className="mb-2">Stock: {item.stock} </Badge>
                    <Row className="mb-5">
                        <Col>
                    ...
                    <Row>
                        <Col>
                            {itemCounter !== 0 ?
                                (<>
                                    <Link to="/cart" className="d-grid gap-2"><Button variant="danger" className="py-4" size="lg">Go to cart</ Button></Link>
